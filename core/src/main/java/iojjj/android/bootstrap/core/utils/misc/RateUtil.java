...
public class RateUtil {
    ...
    protected RateUtil(@NonNull final Builder builder) {
    ...
    protected Dialog getDialog(@NonNull String title, @NonNull String content,
                               @NonNull String positiveText, @NonNull String negativeText, @NonNull String neutralText,
                               @NonNull final Runnable onPositive, @NonNull final Runnable onNeutral) {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull final Context context, @NonNull final String appName, @NonNull final String packageName) {
            this.context = context;
            this.appName = appName;
            this.packageName = packageName;
        }

        public Builder(@NonNull final Context context, @StringRes  final int appNameId, @StringRes final int packageNameId) {
            this.context = context;
        ...
        public RateUtil build() throws AssertionError {
            AssertionUtils.assertInstanceOf(context, ContextThemeWrapper.class, "Context");
            AssertionUtils.assertNotEmpty(appName, "Application Name");
            AssertionUtils.assertNotEmpty(packageName, "Application Package Name");
