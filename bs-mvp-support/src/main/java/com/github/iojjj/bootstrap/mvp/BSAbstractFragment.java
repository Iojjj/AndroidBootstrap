...
public abstract class BSAbstractFragment extends Fragment implements BSMvpDelegate {
    ...
    @Override
    public <TView extends BSMvpView<TPresenter>, TPresenter extends BSMvpPresenter<TView>> void initPresenter(int loaderId, @NonNull TView view, @NonNull BSFunction0<TPresenter> presenterProvider) {
