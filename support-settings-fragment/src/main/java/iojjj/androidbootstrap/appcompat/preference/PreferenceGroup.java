...
public abstract class PreferenceGroup extends Preference implements GenericInflater.Parent<Preference> {
    ...
    PreferenceGroup(Context context, AttributeSet attrs, int defStyle, int defStyleId) {
        super(context, attrs, defStyle, defStyleId);

        mPreferenceList = new ArrayList<Preference>();

        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.PreferenceGroup, defStyle, defStyleId);

        assert a != null;
        mOrderingAsAdded = a.getBoolean(R.styleable.PreferenceGroup_android_orderingFromXml,
                mOrderingAsAdded);
        a.recycle();
    }
     ...
     * also {@link iojjj.androidbootstrap.appcompat.preference.PreferenceGroup PreferenceGroups}.
     * 
