...
import iojjj.androidbootstrap.appcompat.internal.util.XmlUtils;

/**
 * The {@link iojjj.androidbootstrap.appcompat.preference.PreferenceInflater} is used to inflate preference hierarchies from
 * XML files.
 */
class PreferenceInflater extends GenericInflater<Preference, PreferenceGroup> {
    ...
    private void init(PreferenceManager preferenceManager) {
        ...
        setDefaultPackage(PreferenceInflater.class.getPackage().getName() + ".");
    }
