...
/**
 * Used to help create {@link iojjj.androidbootstrap.appcompat.preference.Preference} hierarchies
...
public class PreferenceManager {
    ...
    /**
     * The SharedPreferences name that will be used for all {@link iojjj.androidbootstrap.android.appcompat.preference.Preference}s
     * managed by this instance.
     */
    private String mSharedPreferencesName;

    /**
     * The SharedPreferences mode that will be used for all {@link iojjj.androidbootstrap.android.appcompat.preference.Preference}s
     * managed by this instance.
     */
    private int mSharedPreferencesMode;

    /**
     * The {@link iojjj.androidbootstrap.android.appcompat.preference.PreferenceScreen} at the root of the preference hierarchy.
     */
    ...
    /**
     * Returns a list of {@link android.app.Activity} (indirectly) that match a given
     * {@link android.content.Intent}.
     *
     * @param queryIntent The Intent to match.
     * @return The list of {@link android.content.pm.ResolveInfo} that point to the matched
     *         activities.
     */
     ...
     * this will use.
     * 
     * @return The name that can be passed to {@link android.content.Context#getSharedPreferences(String, int)}.
     ...
     * this will use.
     * 
     * @return The mode that can be passed to {@link android.content.Context#getSharedPreferences(String, int)}.
     * @see android.content.Context#getSharedPreferences(String, int)
     */
     ...
     *  
     * @return The {@link iojjj.androidbootstrap.android.appcompat.preference.PreferenceScreen} object that is at the root of the hierarchy.
     */
     ...
     * 
     * @param preferenceScreen The root {@link iojjj.androidbootstrap.android.appcompat.preference.PreferenceScreen} of the preference hierarchy.
     * @return Whether the {@link iojjj.androidbootstrap.android.appcompat.preference.PreferenceScreen} given is different than the previous.
     */
    ...
    /**
     * Finds a {@link iojjj.androidbootstrap.android.appcompat.preference.Preference} based on its key.
     * 
     * @param key The key of the preference to retrieve.
     * @return The {@link iojjj.androidbootstrap.android.appcompat.preference.Preference} with the key, or null.
     * @see iojjj.androidbootstrap.android.appcompat.preference.PreferenceGroup#findPreference(CharSequence)
     */
     ...
     * by each {@link iojjj.androidbootstrap.android.appcompat.preference.Preference} item's {@code android:defaultValue} attribute. This should
     ...
     *            {@link iojjj.androidbootstrap.appcompat.preference.PreferenceManager#getDefaultSharedPreferences(android.content.Context)}
     ...
     *            parameter set to true.
     * 
     * @see #setDefaultValues(android.content.Context, int, boolean)
     ...
     * 
     * @see iojjj.androidbootstrap.android.appcompat.preference.PreferenceManager.OnActivityResultListener
     */
    ...
    /**
     * Called by the {@link iojjj.androidbootstrap.appcompat.preference.PreferenceManager} to dispatch a subactivity result.
     */
     ...
     * Registers a listener.
     * 
     * @see iojjj.androidbootstrap.android.appcompat.preference.PreferenceManager.OnActivityStopListener
     */
    ...
    /**
     * Called by the {@link iojjj.androidbootstrap.appcompat.preference.PreferenceManager} to dispatch the activity stop
     * event.
     */
     ...
     * Registers a listener.
     * 
     * @see iojjj.androidbootstrap.android.appcompat.preference.PreferenceManager.OnActivityDestroyListener
     */
    ...
    /**
     * Called by the {@link iojjj.androidbootstrap.appcompat.preference.PreferenceManager} to dispatch the activity destroy
     * event.
     */
    ...
    /**
     * Sets the callback to be invoked when a {@link iojjj.androidbootstrap.android.appcompat.preference.Preference} in the
     * hierarchy rooted at this {@link iojjj.androidbootstrap.appcompat.preference.PreferenceManager} is clicked.
     * 
     ...
     * {@link iojjj.androidbootstrap.android.appcompat.preference.Preference} in the hierarchy rooted at this {@link iojjj.androidbootstrap.android.appcompat.preference.PreferenceScreen} is
     * clicked.
     */
    interface OnPreferenceTreeClickListener {
        /**
         * Called when a preference in the tree rooted at this
         * {@link iojjj.androidbootstrap.android.appcompat.preference.PreferenceScreen} has been clicked.
         * 
         * @param preferenceScreen The {@link iojjj.androidbootstrap.android.appcompat.preference.PreferenceScreen} that the
