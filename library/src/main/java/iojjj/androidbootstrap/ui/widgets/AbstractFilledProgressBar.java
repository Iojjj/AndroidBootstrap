...
public abstract class AbstractFilledProgressBar extends View {
    ...
    private void init(@NotNull Context context, @NotNull AttributeSet attrs) {
        ...
        try {
            ...
            borderPaint.setColor(array.getColor(R.styleable.FilledProgressBar_fpb_borderColor, context.getResources().getColor(R.color.fpb_progress_border)));
            textPaintWhite.setColor(array.getColor(R.styleable.FilledProgressBar_fpb_textColorFilled, context.getResources().getColor(R.color.fpb_progress_textFilled)));
            textPaint.setColor(array.getColor(R.styleable.FilledProgressBar_fpb_textColorEmpty, context.getResources().getColor(R.color.fpb_progress_textEmpty)));
            ...
            if (resourceId > 0) {
                if (drawable == null) {
                    arcPaint.setColor(array.getColor(R.styleable.FilledProgressBar_fpb_fillWith, context.getResources().getColor(R.color.fpb_progress_fill)));
                } else {
                    int width = array.getDimensionPixelSize(R.styleable.FilledProgressBar_fpb_shaderWidth, (int) ImageUtils.dpToPx(context, 144));
                    int height = array.getDimensionPixelSize(R.styleable.FilledProgressBar_fpb_shaderHeight, (int) ImageUtils.dpToPx(context, 144));
