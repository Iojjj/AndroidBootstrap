...
/**
 * Created by Alexander on 12/10/13.
 */
public class AspectImageView extends ImageView {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        aspectX = array.getInt(R.styleable.AspectImageView_aiv_aspectX, -1);
        aspectY = array.getInt(R.styleable.AspectImageView_aiv_aspectY, -1);
        array.recycle();
    }
