...
public class LetterImageView extends ImageView {
    ...
    private static int defaultTextPadding;
    ...
    public static void init(final Context context, int colorsArrayRes, int defaultShape, int defaultTextPadding) throws Resources.NotFoundException {
        ...
        LetterImageView.defaultTextPadding = defaultTextPadding;
    ...
    private void init() {
        ...
        textPadding = defaultTextPadding * getResources().getDisplayMetrics().density;
        shape = defaultShape;
    }
     ...
     * Deprecated. Use {@link iojjj.androidbootstrap.ui.widgets.LetterImageView#setShape(int) setShape} instead.
     */
    @Deprecated
     ...
     * @see iojjj.androidbootstrap.ui.widgets.LetterImageView#setShape(int)
     * @see iojjj.androidbootstrap.ui.widgets.LetterImageView#getShape()
     */
    @Deprecated
    ...
    public static class Colorable implements IColorable {
        private int color;
