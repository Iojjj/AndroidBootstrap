...
public class AppFocusService extends Service {
    ...
    public static final String ACTION_FOREGROUND_APPLICATION = MiscellaneousUtils.getAction("ACTION_FOREGROUND_APPLICATION");
    public static final String EXTRA_IS_FOREGROUND = MiscellaneousUtils.getExtra("EXTRA_IS_FOREGROUND");
