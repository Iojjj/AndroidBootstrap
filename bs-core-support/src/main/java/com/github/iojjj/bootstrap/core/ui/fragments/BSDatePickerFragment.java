...
/**
 * Implementation of {@link android.app.DialogFragment} with {@link DatePickerDialog}. Result of date picking
...
public class BSDatePickerFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        return mDelegate.onCreateDialog(getArguments(), getContext());
    }
